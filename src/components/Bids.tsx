...
const Bids: React.FC<BidsProps> = ({ readyToPlay, current_bidder, bids, players, player, handleBidClick }) => {
  ...
  return (
    <div className={styles.container}>
        ...
        <div id="player_1_bid" className={`${styles.player_1_bid} ${styles.bid}`}>0</div> 
        <div id="player_2_bid" className={`${styles.player_2_bid} ${styles.bid}`}>0</div> 
        <div id="player_3_bid" className={`${styles.player_3_bid} ${styles.bid}`}>0</div> 
        <div id="player_4_bid" className={`${styles.player_4_bid} ${styles.bid}`}>0</div> 
    </div>
  );
};
